...
function myKeyDown(e)
{
	...
	if((ball_x==hole_x)&&(ball_y==hole_y)){
		...
		document.getElementyById("hd3").innerHTML="Você atingiu o objetivo!!!";
	...
	function up()
	{
		...
		if(ball_y <=5) {
			...
			console.log("Altura da imagemndo bloco = " + block_image_height);
	...
	function left()
	{
		...
		if(ball_x >5)
		{
			...
			console.log("Largura da imagemndo bloco = " + block_image_width);
